	...
	<view class="wrap">
		<view class="item-warp">
			<view class="item" v-for="(item, index) in list" :key="index">
				<u-lazy-load height="200" round="10" :image="item.src" :index="index" @statusChange="statusChange" @clickImg="clickImg"></u-lazy-load>
			</view>
		</view>
	...
	export default {
		...
		methods: {
			...
			getData() {
				...
				setTimeout(() => {
					for(let i = 0; i < 10; i++) {
						index = uni.$u.random(0, this.data.length - 1);
						this.list.push({
