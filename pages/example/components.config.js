...
},
{
    ...
    {
        path: '/pages/componentsC/cascader/cascader',
        icon: 'cascader',
    ...
    },
    {
        ...
        path: '/pages/componentsC/areaPicker/areaPicker',
        icon: 'areaPicker',
    ...
    list: [{
        ...
        path: '/pages/componentsB/circleProgress/circleProgress',
        icon: 'progress',
        title: 'circleProgress 圆环进度条',
        title_en: 'circleProgress'
    },{
        path: '/pages/componentsC/amount/amount',
        icon: 'progress',
        title: 'Amount 金融数字',
        title_en: 'Amount'
    },
...
},
{
    ...
    list: [
        {
            path: '/pages/componentsA/fab/fab',
            icon: 'fab',
            title: 'Fab 悬浮按钮',
            title_en: 'fab'
        },
        {
            path: '/pages/componentsC/pagination/pagination',
            icon: 'pagination',
            title: 'Pagination 分页',
            title_en: 'Pagination'
        },
...
},
{
    ...
    {
        path: '/pages/componentsC/markdown/markdown',
        icon: 'markdown',
        title: 'Markdown 解析器',
        title_en: 'Markdown'
    },
    ...
    {
        path: '/pages/componentsC/qrcode/qrcode',
        icon: 'qrcode',
        title: 'Qrcode 二维码',
        title_en: 'Qrcode'
    },
    ...
    {
        path: '/pages/componentsA/ellipsis/ellipsis',
        icon: 'ellipsis',
        title: 'Ellipsis 文本省略',
        title_en: 'Ellipsis'
    },
